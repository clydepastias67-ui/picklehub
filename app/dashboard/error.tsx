  ...
  return (
    <div style={{ fontFamily:"'Barlow Condensed',sans-serif", background:'var(--bg-primary)', color:'var(--text-primary)', minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center', padding:24 }}>
      <div style={{ textAlign:'center', maxWidth:440 }}>
        ...
        <h1 style={{ fontSize:28, fontWeight:800, textTransform:'uppercase', letterSpacing:'.04em', marginBottom:8 }}>Dashboard error</h1>
        <p style={{ fontFamily:"'Barlow',sans-serif", fontSize:14, color:'var(--text-muted)', marginBottom:28, lineHeight:1.6 }}>
          We couldn't load your dashboard. This might be a connection issue with our database.
        </p>
        <div style={{ display:'flex', gap:12, justifyContent:'center', flexWrap:'wrap' }}>
          ...
          <a href="/login" style={{ background:'transparent', color:'var(--text-secondary)', border:'1px solid var(--border)', padding:'10px 24px', borderRadius:8, fontFamily:"'Barlow Condensed',sans-serif", fontSize:13, fontWeight:700, letterSpacing:'.06em', textTransform:'uppercase', textDecoration:'none' }}>
            Back to login
          </a>
        </div>
