...
export async function POST(req: Request) {
  try {
    ...
    if (existing) {
      return NextResponse.json({ message: 'Confirmation already sent' });
    }
    ...
    const duration = (endDate.getTime() - bookingDate.getTime()) / (1000 * 60 * 60);
    const subject = `✅ Booking confirmed — ${courtName} on ${formattedDate}`;
        ...
        <body style="margin:0;padding:0;background:#0f0f0f;font-family:'Helvetica Neue',sans-serif;">
          <div style="max-width:560px;margin:40px auto;padding:0 16px;">
            ...
            <div style="background:#161616;border:1px solid #1e1e1e;border-radius:12px 12px 0 0;padding:28px 32px;text-align:center;">
              ...
              <div style="color:#639922;font-size:11px;letter-spacing:0.1em;text-transform:uppercase;">Booking Confirmation</div>
            </div>
            ...
            <div style="background:#161616;border:1px solid #1e1e1e;border-top:none;padding:32px;">
              ...
              <div style="background:rgba(99,153,34,0.1);border:1px solid rgba(99,153,34,0.3);border-radius:10px;padding:20px;margin-bottom:24px;text-align:center;">
                ...
                <div style="color:#a3d45a;font-size:22px;font-weight:800;text-transform:uppercase;letter-spacing:0.04em;">You're booked!</div>
                <div style="color:#888;font-size:13px;margin-top:4px;">Payment received — your court is secured</div>
              </div>

              <p style="color:#aaa;font-size:15px;line-height:1.6;margin-bottom:24px;">
                Hi ${userName || 'there'}, your court booking at Picklverse has been confirmed. See you on the court!
              </p>
              ...
              <div style="background:#1e1e1e;border-radius:10px;padding:20px;margin-bottom:24px;">
                ...
                <table style="width:100%;border-collapse:collapse;">
                  ...
                  <tr>
                    <td style="color:#555;font-size:12px;text-transform:uppercase;letter-spacing:0.06em;padding:10px 0;border-bottom:1px solid #2a2a2a;">Duration</td>
                    <td style="color:#aaa;font-size:14px;padding:10px 0;border-bottom:1px solid #2a2a2a;text-align:right;">${duration} hour${duration !== 1 ? 's' : ''}</td>
                  </tr>
                  <tr>
              ...
              <div style="background:#1a1a1a;border:1px solid #222;border-radius:10px;padding:18px;margin-bottom:24px;">
                <div style="color:#555;font-size:11px;text-transform:uppercase;letter-spacing:0.08em;margin-bottom:10px;">What's next</div>
                <ul style="margin:0;padding:0 0 0 18px;color:#777;font-size:13px;line-height:1.9;">
                  <li>You'll get a reminder email 1 hour before your session</li>
            ...
            <div style="background:#111;border:1px solid #1e1e1e;border-top:none;border-radius:0 0 12px 12px;padding:16px 32px;text-align:center;">
              <p style="color:#333;font-size:11px;margin:0;">© ${new Date().getFullYear()} Picklverse · Booking confirmation</p>
            </div>
          </div>
        </body>
        </html>
